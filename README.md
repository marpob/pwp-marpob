...
- ssh into the server
    - For Mac and Linux: `ssh root@martinpoboril.com`
    - For Windows: Set up a new PuTTY session
        ...
        - **Session**
            ...
            - Click Save
- create user
    - `useradd -m -s /bin/bash -g users -G sudo mpoboril`
    - replace mpoboril with your own
- create password
    - `passwd mpoboril`
- Move .ssh key file
    - `cp -r .ssh /home/mpoboril`
- change ownership of the .ssh directory
    - `cd /home/mpoboril`
    - `chown -R mpoboril:users .ssh/`


- Test Changes
    - `exit`
    - Mac/Linux: `ssh mpoboril@martinpoboril.com`
    - Windows:
        - **Session**
            - Click pwp
            - Click Load
...
- reboot
    - `sudo reboot`
- ssh back in
- `ssh mpoboril@martinpoboril.com`
...
- create a directory for your deployment
    - `sudo mkdir -p /var/www/martinpoboril.com/html`
- fix permissions
    - `sudo chown -R $USER:users /var/www/martinpoboril.com/html`
...
- `sudo vim /etc/nginx/sites-available/martinpoboril.com`
...
server {
    ...
    root /var/www/martinpoboril.com/html;
    index index.html index.htm index.nginx-debian.html;

    server_name martinpoboril.com www.martinpoboril.com;
...
- create a symlink to the sites-enabled directory
    - `sudo ln -s /etc/nginx/sites-available/martinpoboril.com /etc/nginx/sites-enabled/`
...
- Create a new ssh key on your server in the .ssh directory
    - `ssh-keygen -t ed25519 -C  "github Deploy Key" -f /home/mpoboril/.ssh/github_deploy_key`
    - Don't enter a passphrase
        - hit enter twice
- Copy the public key into your authorized keys file
    - `cat /home/mpoboril/.ssh/github_deploy_key.pub >> /home/mpoboril/.ssh/authorized_keys`
...
- Copy the private key to your clipboard **(this is a very dangerous operation do not share this key with anyone )**
    ...
    - `cat /home/mpoboril/.ssh/github_deploy_key`
